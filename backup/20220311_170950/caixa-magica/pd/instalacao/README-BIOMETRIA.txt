...
Após isso, apenas executar o projeto o arquivo "GravadorBiometrico.pyee" com o leitor Plugado na porta USB para executar a gravação das 
biometrias.

O arquivo Application.pyee é a aplicação da caixa mágica.
O arquivo GravadorBiometrico.pyee é o arquivo que executa um software a parte para gravação das biometrias