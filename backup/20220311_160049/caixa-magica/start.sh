...
sudo pyconcrete /home/pi/caixa-magica/sincronismo/sincronismo_check_sistema_alive.pye &
...
echo "Iniciando BD"
sudo pyconcrete /home/pi/caixa-magica/start_conf_postgresql.pye

sudo pyconcrete /home/pi/caixa-magica/core/libera_portas.pye

# Executa scripts de criação BD
sleep 2
echo "Rodando script criacao BD"
sudo pyconcrete /home/pi/caixa-magica/scripts_bd/script_bd.pye

# Executa script criacao jsons basicos
cd $HOME_CM
sudo pyconcrete /home/pi/caixa-magica/gera_jsons_linha_base.pye 
sudo pyconcrete /home/pi/caixa-magica/download_bibliotecas.pye 

#FILE=$HOME_CM-teste-HW/teste_realizado.txt

#if test ! -f "$FILE"; then
#    sudo pyconcrete /home/pi/caixa-magica-teste-HW/view.pye
#fi
unclutter -idle 0 &
xset s off &
xset -dpms &
...
sudo pyconcrete /home/pi/caixa-magica/start.pye
